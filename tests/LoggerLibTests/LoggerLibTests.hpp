...
class LoggerLibTests 
{
    public:
        ...
        /**
         * Проверка парвильной десерелизации сообщения.
         * 
         * Тестирует правильность десерелизации из серелизованной
         * строки, методом round-trip и дополнительно 
         * проверяются пограничные случаи валидной строки.
         */
        static void formater_roundtrip_test();
};
